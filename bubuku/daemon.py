...
def apply_features(config: Config, controller: Controller, buku_proxy: BukuExhibitor, broker: BrokerManager,
...
def main():
    ...
    apply_features(config, controller, buku_proxy, broker, kafka_properties, amazon)
